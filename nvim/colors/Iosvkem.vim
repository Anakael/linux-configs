...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1d1f', '#d02b61', '#60aa00', '#d08928', '#5c8ee8', '#b77fdb', '#00aa80', '#dddddd', '#707070', '#d02b61', '#60aa00', '#d08928', '#5c8ee8', '#b77fdb', '#00aa80', '#ffffff']
  ...
  hi CursorLineNr guifg=#20bbfc guibg=#1c1d1f gui=NONE cterm=NONE
  hi DiffAdd guifg=#40bb40 guibg=#1c1d1f gui=reverse cterm=reverse
  hi DiffChange guifg=#80aacc guibg=#1c1d1f gui=reverse cterm=reverse
  hi DiffDelete guifg=#cc4040 guibg=#1c1d1f gui=reverse cterm=reverse
  hi DiffText guifg=#d496d7 guibg=#1c1d1f gui=reverse cterm=reverse
  hi Directory guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi ErrorMsg guifg=#dddddd guibg=#1c1d1f gui=reverse cterm=reverse
  hi FoldColumn guifg=#707070 guibg=#1c1d1f gui=NONE cterm=NONE
  hi Folded guifg=#707070 guibg=#1c1d1f gui=italic cterm=italic
  hi IncSearch guifg=#fcbb20 guibg=#1c1d1f gui=reverse cterm=reverse
  hi LineNr guifg=#404040 guibg=#1c1d1f gui=NONE cterm=NONE
  hi MatchParen guifg=#fc20bb guibg=#1c1d1f gui=bold cterm=bold
  hi ModeMsg guifg=#dddddd guibg=#1c1d1f gui=bold cterm=bold
  hi MoreMsg guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi NonText guifg=#707070 guibg=#1c1d1f gui=NONE cterm=NONE
  hi Pmenu guifg=#1c1d1f guibg=#80aacc gui=NONE cterm=NONE
  hi PmenuSbar guifg=#dddddd guibg=#707070 gui=NONE cterm=NONE
  hi PmenuSel guifg=#1c1d1f guibg=#d496d7 gui=NONE cterm=NONE
  hi PmenuThumb guifg=#dddddd guibg=#d496d7 gui=NONE cterm=NONE
  hi Question guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi Search guifg=#20bbfc guibg=#1c1d1f gui=reverse cterm=reverse
  hi SignColumn guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi SpecialKey guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi SpellBad guifg=#fc20bb guibg=#1c1d1f gui=underline cterm=underline
  hi SpellCap guifg=#20bbfc guibg=#1c1d1f gui=underline cterm=underline
  hi SpellLocal guifg=#bb20fc guibg=#1c1d1f gui=underline cterm=underline
  hi SpellRare guifg=#20fcbb guibg=#1c1d1f gui=underline cterm=underline
  hi StatusLine guifg=#dddddd guibg=#303030 gui=bold cterm=bold
  hi StatusLineNC guifg=#707070 guibg=#1c1d1f gui=underline cterm=underline
  hi TabLine guifg=#dddddd guibg=#303030 gui=NONE cterm=NONE
  hi TabLineFill guifg=#dddddd guibg=#303030 gui=NONE cterm=NONE
  hi TabLineSel guifg=#dddddd guibg=#1c1d1f gui=bold cterm=bold
  hi Title guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  hi VertSplit guifg=#707070 guibg=#1c1d1f gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi WarningMsg guifg=#dddddd guibg=#1c1d1f gui=NONE cterm=NONE
  ...
  hi Error guifg=#ff2040 guibg=#1c1d1f gui=bold,reverse cterm=bold,reverse
  ...
  hi CursorIM guifg=#1c1d1f guibg=#bbfc20 gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#1c1d1f gui=NONE cterm=NONE
  hi ToolbarButton guifg=#dddddd guibg=#1c1d1f gui=bold cterm=bold
