...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "", "", "", ""}, s, {awful.layout.layouts[3], awful.layout.layouts[3],awful.layout.layouts[2],awful.layout.layouts[1]})
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey}, "KP_Add", function () volumecfg:up() end),
    awful.key({modkey}, "KP_Subtract", function () volumecfg:down() end),
    awful.key({modkey}, "KP_Divide", function () volumecfg:toggle() end),
    ...
    awful.key({ modkey, }, 'f', function ()
        ...
        awful.client.run_or_raise(filemanager, matcher)
        end),
...
client.connect_signal("manage", function (c)
    -- Set the windows at the slave,awful
